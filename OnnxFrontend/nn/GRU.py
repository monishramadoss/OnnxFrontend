...
class GRU_3:
	...
	output_sequence = m_int()
	def __init__(self, _name: str, activation_alpha: list, activation_beta: list, activations: list, clip: float, direction: str, hidden_size: int, linear_before_reset: int, output_sequence: int):
		self.name = _name
		self.m_activation_alpha = activation_alpha
		self.m_activation_beta = activation_beta
		self.m_activations = activations
...
class GRU_7:
	...
	hidden_size = m_int()
	linear_before_reset = m_int()
	def __init__(self, _name: str, activation_alpha: list, activation_beta: list, activations: list, clip: float, direction: str, hidden_size: int, linear_before_reset: int):
		self.name = _name
		self.m_activation_alpha = activation_alpha
		self.m_activation_beta = activation_beta
		self.m_activations = activations
